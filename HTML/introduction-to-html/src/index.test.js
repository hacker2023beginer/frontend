    ...
    describe('HTML page', () => {
        ...
        describe('<body>', () => {
            it(`should have comment with the text: 
                'This page is created for text "This page is created for the 'Introduction to HTML' training course."`, () => {
        ...
        describe('<footer>', () => {
            it('should have  tag with a paragraph inside it with the text "© My Copyright"', () => {
